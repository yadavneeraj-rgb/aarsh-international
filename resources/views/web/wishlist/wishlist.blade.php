...
@section('title', 'Whislist | Neeraj E-Commerce')
@section('content')
						...
						<table class="table">
							...
							<tbody>
								<tr class="text-center">
									...
									<td class="image-prod">
										<div class="img"
											style="background-image:url({{asset('web-assets/images/product-1.jpg')}});">
										</div>
									</td>
								...
								<tr class="text-center">
									...
									<td class="image-prod">
										<div class="img"
											style="background-image:url({{asset('web-assets/images/product-2.jpg')}});">
										</div>
									</td>
								...
								<tr class="text-center">
									...
									<td class="image-prod">
										<div class="img"
											style="background-image:url({{asset('web-assets/images/product-5.jpg')}});">
										</div>
									</td>
								...
								<tr class="text-center">
									...
									<td class="image-prod">
										<div class="img"
											style="background-image:url({{asset('web-assets/images/product-6.jpg')}});">
										</div>
									</td>
