<footer class="footer_section position-relative">
    <div class="footer_section_wrap sec_top_space_50"
        style="background-image: url({{ asset('web-assets/images/footer.png') }})">
        <div class="container">
            <div class="footer_top_content d-flex flex-column flex-lg-row justify-content-between align-items-center">
                <div class="footer_top_logo" style="background: #fff;border-radius: 6px;">
                    <a href="{{ route('home') }}">
                        <img style="width: 100px;" src="http://www.aarshinternational.com./img/logo.png"
                            alt="Aarsh International">
                    </a>
                </div>
                <div class="footer_top_subs position-relative">
                    <input class="rounded-pill" type="tel" name="phone_number" id="phone_number"
                        placeholder="Your Phone Number">
                    <button type="button" class="btn custom_btn rounded-pill text-white position-absolute"
                        onclick="subscribe()">
                        Subscribe Now <i class="fas fa-long-arrow-alt-right"></i>
                    </button>
                </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="footer_inner_choose_content">
                                <div class="footer_inner_choose_title">
                                    <h4><a href="#!" class="text-white">Why People Like us</a></h4>
                                </div>
                                <div class="footer_inner_choose_desc pt-2">
                                    <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
                                        aliquip ex ea commodo. Build your online store with WooCommerce the most popular
                                    </p>
                                </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="footer_inner_info_content">
                                <div class="footer_inner_info_title">
                                    <h4><a href="#!" class="text-white">Information</a></h4>
                                </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="footer_inner_acct_content">
                                <div class="footer_inner_acct_title">
                                    <h4><a href="#!" class="text-white">My Account</a></h4>
                                </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="footer_inner_cotc_content">
                                <div class="footer_inner_ctc_title">
                                    <h4><a href="#!" class="text-white">Contact Us</a></h4>
                                </div>
                                <div class="footer_inner_ctc_info pt-2 text-white">
                                    <p>Address: <font>M-01 , Building No.8, Al Aweer Fruit & Vegetable Market, Dubai,
                                            U.A.E</font>
                                    </p>
                                    <p>Email: <font>sales@aarshinternational.com</font>
                                    </p>
                                    <p>Phone: <font>+971 XX XXX XXXX</font>
                                    </p>
                                    <div class="footer_inner_payment_ctc">
                                        ...
                                        <div class="footer_inner_payment_thumb pt-3">
                                            <a href="#!"><img src="{{ asset('web-assets/images/payment.png') }}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="footer_bootom_copyright">
                                    <p>Copyright © AARSH INTERNATIONAL, All Right Reserved. | Developed By <font>PEARL
                                            ORGANISATION</font>
                                    </p>
                                </div>
                            </div>
