...
@section('content')
				...
				<div class="row align-items-center">
					<div class="col-md-6">
						<div class="product_gallery aos-init aos-animate" data-aos="fade-up" data-aos-duration="1000">
							<img src="{{asset("web-assets/images/sale8.png")}}" alt="image_not_found">
						</div>
					</div>
					<div class="col-md-6">
	...
	<section class="category_section sec_ptb_100 position-relative overflow-hidden clearfix" data-aos="fade-up"
		...
		<!-- banner side image start -->
		<img class="category_left_thumb position-absolute" src="{{asset("web-assets/images/shape3.png")}}"
			alt="image_not_found">
		<!-- banner side image end -->
	</section>
	...
	<section class="sale_section position-relative" data-aos="fade-up" data-aos-duration="2000">
		...
		<!-- banner side image start -->
		<img class="sale_right_thumb position-absolute" src="{{asset("web-assets/images/shape4.png")}}"
			alt="image_not_found">
		<!-- banner side image end -->
	</section>
	<!-- sale section start -->
	...
	<section class="fresh-products-wrapper">
		<div class="container">
			<div class="fresh-prod-container">
				...
				<button class="fresh-prod-download-btn" id="downloadPdfBtn">
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<p>Enter your phone number to subscribe and download PDFs</p>
								<input type="tel" class="form-control" id="modalPhoneNumber"
									placeholder="Your Phone Number">
								<div class="alert alert-danger mt-2 d-none" id="errorMessage"></div>
							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
								<button type="button" class="btn btn-primary" onclick="subscribeFromModal()">Subscribe &
									Download</button>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-6">
					<ul class="product_tabnav_1 nav nav-pills ul_li_right mb-3" id="pills-tab" role="tablist">
						...
						@foreach($categories->take(4) as $category)
							<li class="nav-item" role="presentation">
								<button class="nav-link rounded-pill me-1" id="pills-{{ $category->slug }}-tab"
			...
			<div class="tab-content" id="pills-tabContent">
									...
									<div class="product_layout_content bg-white position-relative">
										<div class="product_image_wrap">
											<a class="product_image d-flex justify-content-center align-items-center"
												...
												@if($product->image)
													...
													<img class="pic-2" src="{{ asset('storage/' . $product->image) }}"
														alt="{{ $product->name }}">
												@else
													<img class="pic-1" src="{{ asset('web-assets/images/product1.png') }}"
														alt="image_not_found">
													<img class="pic-2" src="{{ asset('web-assets/images/product2.png') }}"
														alt="image_not_found">
												@endif
											</a>
													...
													<li>
														<span class="product_badge badge_discount position-absolute rounded-pill"
															style="
																		   ...
																		   font-size:12px; 
																		   color:#fff;  
																		   background-color: {{ $percentage > 0 ? '#ff4d4d' : '#28a745' }};">
															@if($percentage > 0)
											...
											<ul class="product_action_btns ul_li_block d-flex">
												<li><a class="tooltips" data-placement="top" title="Search Product" href="#!">
														<i class="fas fa-search"></i></a>
												</li>
												<li><a class="tooltips" data-placement="top" title="Add To Cart"
														href="#product_quick_view" data-bs-toggle="modal">
						...
						@if($freshProducts->count() == 0)
							<div class="col-12 text-center">
								<div class="no-products">
									...
									<h4>No Products Available</h4>
									<p class="text-muted">Check back later for our fresh products</p>
								</div>
							</div>
						@endif
					</div>
				...
				@foreach($categories->take(4) as $category)
					<div class="tab-pane fade" id="pills-{{ $category->slug }}" role="tabpanel"
						...
						<div class="row g-4">
							@php
								$categoryProducts = $freshProducts->where('category_id', $category->id)->take(8);
							@endphp
							...
							@foreach($categoryProducts as $product)
								<div class="col-sm-6 col-md-6 col-xl-3">
									<div class="product_layout_1 overflow-hidden position-relative">
										<div class="product_layout_content bg-white position-relative">
											<div class="product_image_wrap">
												<a class="product_image d-flex justify-content-center align-items-center" href="#">
													@if($product->image)
														<img class="pic-1" src="{{ asset('storage/' . $product->image) }}"
															alt="{{ $product->name }}">
														<img class="pic-2" src="{{ asset('storage/' . $product->image) }}"
												...
												<ul class="product_badge_group ul_li_block">
													...
													{{-- SAME PRICE CHANGE LOGIC AS ALL PRODUCTS --}}
													@php
														$percentage = $product->percentage_change;
													@endphp
			...
			<div class="row justify-content-center align-items-center">
				<div class="col-md-6 col-lg-4">
					<div class="deal_item_content_wrap">
						<div class="deal_item_content position-relative"
							style="background-image: url({{asset("web-assets/images/deals1.png")}});" data-aos="flip-right"
							data-aos-duration="1000">
							<div class="deal_item_txt position-absolute">
								...
								<div class="deal_btn">
									<a href="shop-list.html"><button type="button" class="btn">SHOP NOW
				...
				<div class="col-md-6 col-lg-4">
					<div class="deal_item_content_wrap">
						<div class="deal_item_content position-relative"
							style="background-image: url({{asset("web-assets/images/deals2.png")}});" data-aos="flip-right"
							data-aos-duration="1500">
							<div class="deal_item_txt position-absolute">
				...
				<div class="col-md-6 col-lg-4">
					<div class="deal_item_content_wrap">
						<div class="deal_item_content position-relative"
							style="background-image: url({{asset("web-assets/images/deals3.png")}});" data-aos="flip-right"
							data-aos-duration="2000">
							<div class="deal_item_txt position-absolute">
	...
	<section class="quality_section position-relative" data-aos="fade-up" data-aos-duration="2000">
		<div class="quality_section_wrap sec_ptb_100"
			style="background-image: url({{asset("web-assets/images/qlty1.png")}})">
			<div class="container">
...
@push('scripts')
	...
	<script>
		document.addEventListener('DOMContentLoaded', function () {
			...
			tabButtons.forEach(button => {
				button.addEventListener('click', function () {
					...
					const targetContent = document.querySelector(`.fresh-prod-tab-content[data-tab="${tabName}"]`);
					if (targetContent) {
		...
		function getCsrfToken() {
			...
			// Fallback: try to get from Laravel's built-in token
		...
		function checkSubscriptionStatus() {
			...
			fetch('/check-subscription', {
				...
				.then(data => {
					...
					if (data.subscribed) {
						// User is subscribed, enable direct download
						document.getElementById('downloadPdfBtn').onclick = downloadPdf;
						document.getElementById('downloadPdfBtn').innerHTML = '<i class="fas fa-download"></i> Download Current List';
						console.log('User subscribed with:', data.phone_number);
					} else {
						// User not subscribed, show modal on click
						document.getElementById('downloadPdfBtn').onclick = showSubscriptionModal;
						document.getElementById('downloadPdfBtn').innerHTML = '<i class="fas fa-download"></i> Download Current List';
					}
				})
				.catch(error => {
		...
		function subscribeFromModal() {
			...
			subscribe(phoneNumber, true);
		}

		function subscribe(phoneNumber = null, fromModal = false) {
			const phone = phoneNumber || document.getElementById('phone_number')?.value;
			...
			console.log('Subscribing with phone:', cleanPhone);
			console.log('Endpoint:', '/subscribe');

			// Show loading state
			const submitBtn = fromModal ? document.querySelector('#subscriptionModal .btn-primary') : null;
			if (submitBtn) {
			...
			fetch('{{route('subscribe')}}', {
				...
				.then(data => {
					...
					if (data.success) {
						...
						if (fromModal) {
							...
							// Show success message for footer subscription
				...
				.catch(error => {
					...
					if (error.message.includes('404')) {
						console.error('Route not found. Please check server configuration.');
					}
				})
				.finally(() => {
					// Reset button state
					if (submitBtn) {
						submitBtn.innerHTML = 'Subscribe & Download';
		...
		function showSuccess(message) {
			// You can implement a nice success notification here
		...
		function downloadPdf() {
			...
			const activeTab = document.querySelector('.fresh-prod-tab-btn.active');
			if (!activeTab) {
			...
			// Extract category ID from tab name
			if (tabName !== 'all') {
				categoryId = tabName.replace('category-', '');
			}
			...
			fetch(`/download-price-list/${categoryId}`, {
				...
				.then(blob => {
					...
					const filename = `price-list-${categoryId}-${new Date().toISOString().split('T')[0]}.pdf`;
					a.download = filename;
		...
		function generateSimplePdf(categoryName) {
			return new Promise((resolve, reject) => {
				try {
					// Get the table element directly from the DOM
					const tableElement = document.querySelector('.fresh-prod-tab-content.active .fresh-prod-table');
					if (!tableElement) {
					...
					// Create a simple container with the table
					const element = document.createElement('div');
					element.innerHTML = `
						<div style="text-align: center; padding: 20px;">
							<h1 style="color: #2c5aa0; margin-bottom: 10px;">AARSH INTERNATIONAL</h1>
							<h2 style="margin-bottom: 5px;">Price List - ${categoryName}</h2>
							<p style="color: #666;">Generated on: ${getCurrentDate()}</p>
						</div>
					`;
					...
					footer.innerHTML = `
						<div style="margin-top: 20px; padding-top: 10px; border-top: 1px solid #ddd; text-align: center; color: #666; font-size: 12px;">
							<p>M-01, Building No.8, Al Aweer Fruit & Vegetable Market, Dubai, U.A.E</p>
							<p>Email: sales@aarshinternational.com | Phone: +971 XX XXX XXXX</p>
						</div>
					`;
					...
					const opt = {
						margin: 10,
						filename: `price-list-${categoryName.toLowerCase().replace(/\s+/g, '-')}-${getCurrentDate()}.pdf`,
		...
		function generateAndDownloadPdf(categoryName) {
			return new Promise((resolve, reject) => {
				try {
					// Get the active table
					const activeTable = document.querySelector('.fresh-prod-tab-content.active .fresh-prod-table');
					if (!activeTable) {
						alert('No data found for the selected category');
						reject('No table found');
						return;
					...
					const htmlContent = createPdfHtml(activeTable, categoryName);
		...
		function createPdfHtml(tableElement, categoryName) {
			// Clone the table and its content
			const tableClone = tableElement.cloneNode(true);
			...
			return `
				...
				<head>
					...
					<style>
						...
						.fresh-prod-price-cell,
						.fresh-prod-price-previous {
							font-weight: bold;
							color: #2c5aa0;
						}
						.fresh-prod-price-up {
						...
						.fresh-prod-price-down {
							color: #28a745;
							font-weight: bold;
						}
						.fresh-prod-price-neutral {
							color: #6c757d;
						}
						.footer { 
							margin-top: 30px; 
				...
				<body>
					<div class="header">
						<div class="company-name">AARSH INTERNATIONAL</div>
						<div class="document-title">Current Price List</div>
						<div class="category">${categoryName}</div>
						<div class="date">Generated on: ${getCurrentDate()}</div>
					</div>

					${tableClone.outerHTML}

					<div class="footer">
						<div>M-01, Building No.8, Al Aweer Fruit & Vegetable Market, Dubai, U.A.E</div>
						<div style="margin: 5px 0;">Email: sales@aarshinternational.com | Phone: +971 XX XXX XXXX</div>
