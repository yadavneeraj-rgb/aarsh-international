...
// Subscription Routesa
Route::post('/subscribe', [SubscriptionController::class, 'subscribe'])->name('subscribe');
Route::get('/check-subscription', [SubscriptionController::class, 'checkSubscription'])->name('check.subscription');
Route::post('/download-pdf', [SubscriptionController::class, 'downloadPdf'])->name('download.pdf');
Route::post('/unsubscribe', [SubscriptionController::class, 'unsubscribe'])->name('unsubscribe');
Route::get('/download-price-list/{categoryId}', [PdfController::class, 'downloadPriceList'])->name('download.price.list');
...
Route::middleware(['auth'])->group(function () {
    ...
    // Product Routes
    Route::get('/products', [ProductControllers::class, 'products'])->name('products');
    Route::get('/product/create', [ProductControllers::class, 'createProduct'])->name('product.create');
    Route::post('/product', [ProductControllers::class, 'storeProduct'])->name('product.store');
    Route::get('/product/{id}/edit', [ProductControllers::class, 'editProduct'])->name('product.edit');
    Route::put('/product/{id}', [ProductControllers::class, 'updateProduct'])->name('product.update');
    Route::delete('/product/{id}', [ProductControllers::class, 'destroyProduct'])->name('product.destroy');
    Route::put('/product/{id}/toggle-featured', [ProductControllers::class, 'toggleFeatured'])->name('product.toggle-featured');
    ...
    // subscriber
    Route::get('/subscriber', [App\Http\Controllers\Admin\SubscriberController::class, 'subscriber'])->name('subscriber');
});
